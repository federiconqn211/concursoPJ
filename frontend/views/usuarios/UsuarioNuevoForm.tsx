...
export default function UsuarioNuevoForm({usuario, onSubmit}: UsuarioFormProps) {
    ...
    return (
        <div className="flex flex-col gap-s items-start">
            <br/><table className={'table table-gray '}>
                <thead>
                <tr>
                    <td colSpan={5}>NUEVO USUARO</td>
                </tr>
                </thead>
                <tbody>
                <tr>
            ...
            <Button onClick={submit} theme="primary">Guardar Nuevo</Button>
